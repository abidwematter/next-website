...
import { AboutUs, HomeSucessStory, PartnerHomeData } from '../../../../services/shared-service';
                    ...
                    aboutData && aboutData.map((val, i) => (
                        <div className='viir1' key={i}>
                            ...
                            <div className="theme-inner-banner space-fix-one">
                                ...
                                <img src={`${imgUrl}${val?.secimg1}`} alt="" className="shapes illustration-one" />
                            </div>
                            ...
                            <div
                                className="feedback-section-four position-relative pb-75 lg-mt-110 sm-pb-20">
                                <div className="container">

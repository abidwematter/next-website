...
const Registartion = (props) => {
  ...
  async function onFormSubmit(e) {
    ...
    if (registration.name == '') {
      ...
      var validPhone = phone_regex.test(registration.mobile)
      var validEmail  = email_regex.test(registration.email)
      ...
      if (validPhone && validEmail) {
        ...
        if (!validPhone) {
          document.getElementById("mobilenumber").innerHTML = "Please Enter Valid Mobile Number";
        }

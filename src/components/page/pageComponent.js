    ...
    <div className="main-page-wrapper">
      ...
      <div className="hero-banner-two">
        <div className="theme-inner-banner">
          <InnerBanner
            intro={pageData[0]?.page_name}
            currpage={pageData[0]?.page_name}
          />
          {pageData[0]?.banner && pageData[0]?.banner !== "" ? (
            <img
              src={`${img}${pageData[0]?.banner}`}
              alt=""
      ...
      {pageData && pageData[0]?.page_layout == "Full Width Page Layout" ? (
        <FullWidthPage data={pageData[0]} />
      ) : (
        ""
      )}

      {pageData[0]?.page_layout == "Testimonial" ? (
        <Testimonial data={pageData[0]} />
      ) : (
        ""
      )}

      {pageData[0]?.page_layout == "Case Studies" ? (
        <CashStudies data={pageData[0]} />
      ) : (
        ""
      )}
      ...
      {pageData[0]?.page_layout == "Why We Video" ? (
        <EventVideo data={pageData[0]} />
      ) : (
        ""
      )}

      {pageData[0]?.page_layout == "POD Cast" ? (
        <PodCost data={pageData[0]} />
      ) : (
        ""
      )}
      {pageData[0]?.page_layout == "Calculator" ? (
        <Calculator data={pageData[0]} />
      ) : (
        ""
      )}

      {pageData[0]?.page_layout == "Registartion" ? (
        <Registartion data={pageData[0]} />
      ) : (
        ""
      )}

      {pageData[0]?.page_layout == "Company Video" ? (
        <WinnersVideo data={pageData[0]} />
      ) : (
        ""
      )}

      {pageData[0]?.page_layout == "Awards Video" ? (
        <TestimonialVideo data={pageData[0]} />
      ) : (
        ""
      )}

      {pageData[0]?.page_layout == "Winner Photo" ? (
        <WinnerPhoto data={pageData[0]} />
      ) : (
        ""
      )}
      {pageData[0]?.page_layout == "Event Photo" ? (
        <EventPhoto data={pageData[0]} />
      ) : (
        ""
      )}

      {pageData[0]?.page_layout == "About Us" ? (
        <AboutUs data={pageData[0]} />
      ) : (
        ""
      )}

      {pageData[0]?.page_layout == "Founder" ? (
        <Founder data={pageData[0]} />
      ) : (
        ""
      )}

      {pageData[0]?.page_layout == "Management" ? (
        <Management data={pageData[0]} />
      ) : (
        ""
      )}
      ...
      {pageData[0]?.page_layout == "News" ? (
        <NewsComponent data={pageData[0]} />
      ) : (
        ""
      )}
      ...
      {pageData[0]?.page_layout == "Contact Us" ? (
        <ContactUs data={pageData[0]} />
      ) : (
        ""
      )}

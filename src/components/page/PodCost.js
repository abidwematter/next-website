...
import { PODCastData } from '../../services/shared-service'
...
const PodCost = (props) => {
  ...
  const getPaginatedData = (page) => {
     pageData = page
     PODCastData(pageData).then((res) => {
      setPodCastValue(res?.data)
        ...
        <div className="container">
          <div className="row gx-xxl-5">
            <div className="col-lg-10">
              <BlogMasonryOne data={podCastValue}/>
            ...
            <div className="col-lg-2 col-md-6">
              <div className="blog-sidebar ps-xl-5 ps-lg-3 me-xxl-5 mt-45 md-mt-70">
                ...
                <div className="sidebar-category mb-50">
                  ...
                  {podCastValue && podCastValue.length > 0 ? <Category data={podCastValue[0].category_id}/>  : ''}

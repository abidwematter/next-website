                        ...
                        {props?.data?.map((val, i) => (
                            <div
                                ...
                                <div className="portfolio-block-one mt-40 xs-mt-30">
                                    <div className="img-meta" style={{ maxWidth: "450px", height: "422px" }}><img src={`${img}${val.banner}`} alt="" className="w-100" style={{ maxWidth: "450px", height: "280px" }} /></div>
                                    <Link
                                        href={`/${val?.slug}`}
                                        ...
                                        <span className="tag">
                                            {val.short_description.length > MAX_LENGTH ?
                                                (
                                                    <div dangerouslySetInnerHTML={{ __html: (val.short_description.substring(0, MAX_LENGTH)) + `...` }} />
                                                ) :

                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-7">
                            ...
                            <ul className="style-none button-group d-lg-flex align-items-center">
                                <li className="me-4"><Link href="/contact" className="btn-one ripple-btn">Start Free Trial</Link></li>
                                <li className="help-btn">Need any help? <Link href="/contact">Contact us</Link></li>
                            </ul>
                        </div>
                    </div>
                </div> {/* /.container */}

                ...
                <div className="inner-content">
                    <div className="d-flex align-items-center justify-content-between">
                        ...
                        <div
                            ...
                            <Link href="/contact" className="req-demo-btn tran3s d-none d-lg-block">Request a Demo</Link>
                        </div>
                        {/* /.right-widget */}
                            ...
                            <div className="collapse navbar-collapse" id="navbarNav">
                                ...
                                <div className="mobile-content d-block d-lg-none">
                                    <div
                                        ...
                                        <Link href="/contact" className="req-demo-btn tran3s">Request a Demo</Link>
                                    </div>
                                </div>
                                {/* /.mobile-content */}
                            </div>

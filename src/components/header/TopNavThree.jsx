                ...
                <div className="inner-content">
                    <div className="container d-flex align-items-center justify-content-between">
                        <div className="logo order-lg-0">
                            <Link href="/" className="d-block"><img src="images/logo/logo_02.png" alt="" width={129}/></Link>
                        </div>
                        <div
                            ...
                            <a href="/contact" className="req-demo-btn tran3s d-none d-lg-block">Request a Demo</a>
                        </div>
                        {/* /.right-widget */}
                            ...
                            <div className="collapse navbar-collapse" id="navbarNav">
                                ...
                                <div className="mobile-content d-block d-lg-none">
                                    <div
                                        ...
                                        <a href="/contact" className="req-demo-btn tran3s">Request a Demo</a>
                                    </div>
                                </div>
                                {/* /.mobile-content */}
                            </div>

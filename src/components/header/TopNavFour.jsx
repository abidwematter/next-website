                ...
                <div className="inner-content">
                    <div className="d-flex align-items-center">
                        <div className="logo order-lg-0">
                            <Link href="/" className="d-block"><img src="images/logo/logo_03.png" alt="" width={90}/></Link>
                        </div>
                        <div className="right-widget d-flex align-items-center ms-auto order-lg-3">
                            ...
                            <Link href="/contact" className="send-msg-btn tran3s d-none d-lg-block">Send us Message</Link>
                        </div>
                        {/* /.right-widget */}
